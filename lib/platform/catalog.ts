...
export const platformModules: PlatformModule[] = [
  ...
  },
  {
    ...
    columns: ['单位', '当前阶段', '本阶段完成度', '关键缺口', '项目经理', '下一节点'],
    rows: [
      ['北京某大学医院', '试运行评审', '88%', '2项P0', '周珊', '整改验收'],
      ['海南某国际医院', '筹建中单位', '73%', '4项P1', '刘然', '模拟评审'],
      ['云南某妇幼保健院', '申报中的单位', '61%', '3项P1', '王宁', '申报材料预审'],
    ],
  },
  {
    slug: 'training',
