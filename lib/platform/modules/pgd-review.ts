...
export const pgdReviewModule: ModuleDefinition = {
  home: {
    code: '评', name: 'PGT资质评审', source: 'BMP / Synology资料库', state: '资料工作台已设计', stateTone: 'teal',
    desc: '覆盖申报、筹建、试运行评审、正式运营及诊疗路径建设。', metric: '5', metricLabel: '全生命周期阶段', tone: 'teal',
  },
  platform: {
    slug: 'pgd-review', short: '评', name: 'PGT资质评审协助', source: 'BMP + Synology评审资料库 + 专家库', owner: '资质评审专项组',
    ...
    columns: ['单位', '当前阶段', '本阶段完成度', '总周期/PGT周期', '项目经理', '下一节点'],
    rows: [
