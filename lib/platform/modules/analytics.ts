...
export const analyticsModule: ModuleDefinition = {
  home: {
    code: '析', name: '数据分析与汇报', source: 'BMP销量 / 医检所数据接口均待确认', state: '分析规则已设计', stateTone: 'teal',
    desc: '薄弱产品、医院运营质量、人员贡献及季度汇报一体化分析。', metric: 'AI', metricLabel: '辅助分析可追溯', tone: 'magenta',
  },
  platform: {
    slug: 'analytics', short: '析', name: '数据分析与汇报', source: 'BMP销量接口待确认 + 医检所运营数据接口待确认', owner: '学术运营与数据分析组',
    ...
    kpis: [
      ...
      { label: '季度PPT汇报', value: '待联调', note: '真实数据接入后生成并复核' },
    ],
    columns: ['分析对象', '分析维度', '核心指标', '当前状态', '责任人', '下一动作'],
    rows: [
      ['产品销量薄弱分析', '产品×医院', '目标达成率/同比', 'BMP接口待确认', '学术运营', '接口字段确认'],
      ['学术支持贡献分析', '人员×医院×产品', '覆盖/增量/转化', 'BMP接口待确认', '部门负责人', '人员映射确认'],
      ['医检所运营质量', '医院×周期', '扩增/阳性/阴性/嵌合率', '医检所接口待确认', '医学与运营', '口径校验'],
    ],
  },
  maintenance: {
